...
export default function FeatureTabsSection() {
  ...
  return (
    <section className="flex w-full justify-center bg-black">
      <div className="container flex w-full flex-col items-center gap-14 px-6 py-20 sm:px-10 lg:px-24 lg:py-24">
          ...
          {featureTabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'group relative flex items-center gap-2.5 border-b-2 border-transparent pb-5 text-left transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:outline-none',
              ...
              >
                ...
                <span className="text-2xl font-normal transition-colors duration-200">
                  {tab.label}
                </span>
                {isActive ? (
                  <motion.span
        ...
        <div className="relative flex w-full max-w-[1200px] justify-center overflow-hidden rounded-[20px] border border-white/10">
